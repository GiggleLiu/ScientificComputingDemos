...
temperatures = [2.269, 3]
# Create a dictionary of acorr_maxtaus for each temperature
acorr_maxtaus_dict = Dict(
    3 => Dict(4 => 10,  8 => 23, 16 => 25, 32 => 30),
    2.269 => Dict(4 => 10,  8 => 70, 16 => 240, 32 => 414)
)
magnetic_field = 0.0

nsteps_heatbath = 20000
nsteps_eachbin = 100
nbins = 2000

 
fig = Figure()
ax = Axis(fig[1, 1], xlabel=L"L", ylabel=L"A_{int|M|}(τ)", xscale=log2, yscale=log10)
...
# Save the figure
save(joinpath(@__DIR__, "acorr3.png"), fig)
