...
import ..KernelPCA
export quadratic, linear, curve, rings, solar_system
...
function solar_system()
    data = CSV.read(joinpath(pkgdir(KernelPCA), "data", "solar_system.csv"), DataFrame)
    return hcat(data.x, data.y, data.z)
end
